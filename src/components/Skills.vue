...
const skills = ref([
  ...
  { name: "CSS", level: 90, animatedLevel: 0 },
  { name: "JavaScript", level: 85, animatedLevel: 0 },
  { name: "Restful API's", level: 96, animatedLevel: 0 },
  { name: "Vue.js", level: 94, animatedLevel: 0 },
  { name: "Nuxt.js", level: 94, animatedLevel: 0 },
  { name: "Tailwind CSS", level: 95, animatedLevel: 0 },
  { name: "Figma", level: 85, animatedLevel: 0 },
  { name: "Version control", level: 88, animatedLevel: 0 },
  { name: "React.js", level: 65, animatedLevel: 0 },
  ...
  { name: "Adaptability ", level: 90, animatedLevel: 0 },
