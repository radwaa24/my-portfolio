...
<template>
  <div class="petal" ref="root">
    ...
    <!-- PROCESS -->
    <section class="sec">
      <span class="lab reveal">( How it works )</span>
      <ul class="serv">
        <li v-for="s in process" :key="s.step" class="reveal-self">
    ...
    <!-- INDUSTRIES -->
    <section class="sec">
      <span class="lab reveal">( Industries I serve )</span>
      <div class="ind-pills reveal-self">
