...
<div className='text-center mt-6'>
    ...
    bg-red-100 p-4 hover:bg-red-50 text-center rounded-3xl'>
        ...
        <p className='font-serif text-slate-800'> A simple App to manage daily tasks by adding items to do and complete or remove them and also disply both using only CSS for styling .</p>
      </article>
    ...
    bg-red-100 p-5 hover:bg-red-50 text-center rounded-3xl'>
        ...
        <p className='font-serif text-slate-800'> Using React hooks and events .</p>
      </article>
      </div>
    </div>
    </body>
